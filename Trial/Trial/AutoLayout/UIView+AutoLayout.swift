...
public enum SL_AlignType {
    ...
    private func layoutAttributes(isInner: Bool, isVertical: Bool) -> SL_LayoutAttributes {
        let attributes = SL_LayoutAttributes()
        ...
        // 仅内部参照需要
        case .Center:
            return SL_LayoutAttributes(horizontal: .CenterX, referHorizontal: .CenterX, vertical: .CenterY, referVertical: .CenterY)
        }
    }
}
...
extension UIView {
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_Fill(referView: UIView, insets: UIEdgeInsets = UIEdgeInsetsZero) -> [NSLayoutConstraint] {
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_AlignInner(type type: SL_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint]  {
        
        return sl_AlignLayout(referView, attributes: type.layoutAttributes(true, isVertical: true), size: size, offset: offset)
    }
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_AlignVertical(type type: SL_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint] {
        
        return sl_AlignLayout(referView, attributes: type.layoutAttributes(false, isVertical: true), size: size, offset: offset)
    }
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_AlignHorizontal(type type: SL_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPointZero) -> [NSLayoutConstraint] {
        
        return sl_AlignLayout(referView, attributes: type.layoutAttributes(false, isVertical: false), size: size, offset: offset)
    }
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        firstView.sl_AlignInner(type: SL_AlignType.TopLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.sl_sizeConstraints(firstView)
            subView.sl_AlignHorizontal(type: SL_AlignType.TopRight, referView: preView, size: nil, offset: CGPoint(x: insets.right, y: 0))
            preView = subView
        }
    ...
    /**
     ...
     :returns: 约束数组
     */
    public func sl_VerticalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.sl_sizeConstraints(firstView)
            subView.sl_AlignVertical(type: SL_AlignType.BottomLeft, referView: preView, size: nil, offset: CGPoint(x: 0, y: insets.bottom))
            preView = subView
        }
    ...
    /**
     ...
     :returns: 对应的约束
     */
    public func sl_Constraint(constraintsList: [NSLayoutConstraint], attribute: NSLayoutAttribute) -> NSLayoutConstraint? {
    ...
    /**
     ...
     :returns: 约束数组
     */
    private func sl_AlignLayout(referView: UIView, attributes: SL_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
        
        translatesAutoresizingMaskIntoConstraints = false
        
        var cons = [NSLayoutConstraint]()
        
        cons += sl_positionConstraints(referView, attributes: attributes, offset: offset)
        
        if size != nil {
            cons += sl_sizeConstraints(size!)
        }
    ...
    /**
     ...
     :returns: 约束数组
     */
    private func sl_sizeConstraints(size: CGSize) -> [NSLayoutConstraint] {
    ...
    /**
     ...
     :returns: 约束数组
     */
    private func sl_sizeConstraints(referView: UIView) -> [NSLayoutConstraint] {
    ...
    /**
     ...
     :returns: 约束数组
     */
    private func sl_positionConstraints(referView: UIView, attributes: SL_LayoutAttributes, offset: CGPoint) -> [NSLayoutConstraint] {
...
///  布局属性
private final class SL_LayoutAttributes {
